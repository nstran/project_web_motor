...
import aplication.data.repository.ProductRepository;
...
public class ProductService {
    ...
    public Product findFirstProductByCategoryOrProductName(int categoryId, int productId) {
        return productRepository.findFirstProductByCategoryIdAndProductId(categoryId, productId);
    }
}
