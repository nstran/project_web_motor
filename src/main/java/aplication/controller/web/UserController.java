...
import aplication.model.viewmodel.user.ChangePasswordVM;
import aplication.model.viewmodel.user.UserDetailVM;
import aplication.model.viewmodel.user.UserVM;
...
public class UserController extends BaseController {
    ...
    public String getUserDetail(@Valid @ModelAttribute("productname") ProductVM productName,
        ...
        userVM.setCmnd(userEntity.getCmnd());
    ...
    public String updateUser(@Valid @ModelAttribute("user") User user) {
        try {
            ...
            userEntity.setCmnd(user.getCmnd());
