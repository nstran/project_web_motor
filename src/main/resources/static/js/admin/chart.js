$(function() {
    ...
    var dataChartCategoryProduct= [];
    var labelChartCategoryProduct = [];

    for(var i=0;i<vm.chartCategoryProductVMS.length;i++) {
        dataChartCategoryProduct.push(vm.chartCategoryProductVMS[i].value);
        labelChartCategoryProduct.push(vm.chartCategoryProductVMS[i].label);
    }
    ...
    var doughnutPieData = {
        ...
        labels: labelChartCategoryProduct
    };
